namespace TEK.Recruit.Web.Utils
{
    public static class HtmlHelper
    {
        public static object GetRemoveUserAccessButtonStyle(this Microsoft.AspNet.Mvc.Rendering.IHtmlHelper htmlHelper, bool hasDeveloper)
        {
            var style1 = new
            {
