...
using Framework.Configuration.Services;
using Framework.Http.Contracts;
using Framework.Http.Services;
...
namespace vNextRc
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IManageCodingExcerciseEnvironment, CodingExcerciseEnvironmentManager>();
